...
public class SkewUI extends JPanel {
	...
	private List<IDataSource> sources;
	
	
	public SkewUI(SkewTabs parent, List<IDataSource> sources)
	{
		this(parent, sources, new SkewController(parent));
	}
	

	public SkewUI(SkewTabs parent, List<IDataSource> sources, final SkewController controller) 
	{
	...
	private JToolBar createToolbar()
	{
		...
		open.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				ISkewDataset dataset = SkewController.loadDataset(parent, controller.data.path(), sources);
				if (dataset != null) {
					//create new UI
					SkewUI ui = new SkewUI(parent, sources);
					ui.dummy = false;
					parent.addTab(ui);
